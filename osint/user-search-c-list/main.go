...
Prog: This is just another option for the user scanner to parse
optional URL files, say if you have a bunch of files with just URL's of users
and you wantr to test them here is the general option
